...
var GpuMesh = {
   ...
   draw : function(gl) {
      ...
      gl.enableVertexAttribArray(texAttributeIndex);
      gl.vertexAttribPointer(texAttributeIndex, 2, gl.FLOAT, false,0,0);
...
var CpuMesh = {
   ...
   /* fields */
    ...
    tex: new Float32Array,    // texture points
  ...
  importOBJfromString:function (string,col/*-1White 1Dark*/){
    ...
    //this.tex= new Float32Array(nvt*2);
    ti+=nvt*3
    ti+=4;
    nf=tokens[ti++];
    ...
    for (var i=0; i<nf; i++) {
      ...
      this.setPoli(countI,vertices,col);
    ...
    makeCube: function(col) {
      ...
      this.setTex(12,colI,0);
      this.setTex(15,colI,1);
      this.setTex(3,colF,0);
      this.setTex(0,colF,1);
      ...
      this.setTex(9,colI,0);
      this.setTex(18,colF,0);
      this.setTex(21,colI,1);
      this.setTex(6,colF,1);
      ...
      this.setTex(7,colI,0);
      this.setTex(19,colI,1);
      this.setTex(1,colF,1);
      this.setTex(13,colF,0);
      ...
      this.setTex(4,colI,0);
      this.setTex(16,colI,1);
      this.setTex(10,colF,1);
      this.setTex(22,colF,0);
      ...
      this.setTex(17,colI,0);
      this.setTex(14,colI,1);
      this.setTex(23,colF,1);
      this.setTex(20,colF,0);
      ...
      this.setTex(5,colI,0);
      this.setTex(11,colI,1);
      this.setTex(2,colF,1);
      this.setTex(8,colF,0);
   ...
   allocate: function( nverts, ntris ) {
      ...
      this.tex = new Float32Array(nverts*2);
   },
   ...
   setPoli: function(i,vertices,col){
    var offset=0.01;
    var dI=0; //horizontally
    var dF=0.25;
    var wI=0.25;
    ...
    for (j=2; j<vertices.length;j++){
      ...
      this.setTex(vertices[0],colI,1);
      this.setTex(vertices[j-1],colF,0);
      this.setTex(vertices[j],colF,0);
    }
